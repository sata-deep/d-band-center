...
!     Calculate band centers (spin up and & spin down) of any arbitary band (p/d etc) 
!     calculates the effective band center
!
      implicit none
      double precision,allocatable :: e(:),du(:),dd(:),idu(:),idd(:)
      double precision,allocatable :: num1(:),den1(:),num2(:),den2(:)
      integer ::N,IERR,i,j,nat,natom,q1,q2
      double precision :: ANS,aden,momav,anum,momu,momd,elo,eup
      double precision ::dmin,dmax,emin,emax,efermi,aa
      double precision :: fup,fdown
      character (len=90) :: filename
      character(len=30)::information
      ...
      read(10,*)
      enddo
      read(10,*)emax,emin,N,efermi,aa
      write(*,*)'Number of energy points in DOSCAR = ',N
...
!
      ...
      print*,"Number of transition metal atoms?"
      read(*,*)nat
      print*,"========================================"
      print*,"             Results:                   "
      print*,"                                        "
!
      ...
      den1(i)=du(i)
      enddo
      call davint(e,num1,N,e(1),efermi,ANS,IERR)
      anum=ANS
      call davint(e,den1,N,e(1),efermi,ANS,IERR)
      aden=ANS
      momu=anum/aden
      call davint(e,den1,N,e(1),efermi,ANS,IERR)
      fup=dabs(ANS/(nat*5.0))
...
!
      ...
      den2(i)=dd(i)
      enddo
      call davint(e,num2,N,e(1),efermi,ANS,IERR)
      anum=ANS
      call davint(e,den2,N,e(1),efermi,ANS,IERR)
      aden=ANS
      momd=anum/aden
      call davint(e,den2,N,e(1),efermi,ANS,IERR)
      fdown=dabs(aden/(nat*5.0))
      write(*,'("Spin-down fractional occupation: ",f4.2)')fdown
      write(*,'("The spin-down center: ",f6.2," eV")')momd
      momav=(fup*momu+(fdown*momd))/(fup+fdown)
      write(*,'("The effective band center: ",f6.2," eV")')momav
      print*,"========================================"
